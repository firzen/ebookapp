<?php /* Smarty version 2.6.27, created on 2014-07-22 17:52:58
         compiled from chpctx_bootstrap_error.htm */ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Frameset//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-frameset.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta charset="gb2312">
    <title>文章采集错误 - 开心猪小说网</title>
...
<div class="navbar">
				<div class="navbar-inner">
					<div class="container-fluid">
						 <a data-target=".navbar-responsive-collapse" data-toggle="collapse" class="btn btn-navbar"><span class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span></a> <a href="#" class="brand">开心猪</a>
...
<div class="container">
	<div class="row-fluid">
		<div class="span12">
			<form class="form-search pull-right" action="/search.php" method="post">
				<input class="input-medium search-query" type="text" name="search_text" /><button class="btn" type="submit">搜索</button>
			</form>
		</div>
	</div>
	...
	<div class="row-fluid">
		<div class ="span12">
			<div class="page-header" contenteditable="true">
                <h1 class="pull-center">sorry,文章采集错误，刷新本页或点击下一页 </h1>
            </div>
		</div>
	</div>
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="pagination">
				<ul>
					<li>
						<a href="/chapter/ctx_<?php echo $this->_tpl_vars['id']; ?>
.html">刷新</a>
					</li>
					<li>
						<a href="/chapter/ctx_<?php echo $this->_tpl_vars['id']-1; ?>
.html">上一页</a>
					</li>
					<li>
						<a href="/chapter/ctx_<?php echo $this->_tpl_vars['id']+1; ?>
